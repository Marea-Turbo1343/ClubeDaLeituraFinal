using CubeDaLeituraFinal.ModuloAmigo;
using CubeDaLeituraFinal.ModuloCaixa;
using CubeDaLeituraFinal.ModuloEmprestimo;
using CubeDaLeituraFinal.ModuloRevista;

namespace CubeDaLeituraFinal.Compartilhado
{
